//
//  ErrorDeterminingLocation.swift
//  ErrorDeterminingLocation
//
...
struct ErrorDeterminingLocation: View {
...
struct ErrorDeterminingLocation_Previews: PreviewProvider {
    static var previews: some View {
        ErrorDeterminingLocation(appState: AppState())
    }
}
