...
public struct Agency: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public struct Stop: Identifiable, Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum LocationType: Int, Codable, Equatable, Hashable, Sendable {
    case stop = 0
    case station = 1
...
public enum WheelchairAccessible: Int, Codable, Equatable, Hashable, Sendable {
...
public struct Route: Identifiable, Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let id: String
...
public enum RouteType: Int, Codable, Equatable, Hashable, Sendable {
...
public struct Trip: Identifiable, Codable, Equatable, Hashable, FromCSVLine, Sendable {
    public let id: String
    public let routeId: String
...
public enum Direction: Int, Codable, Equatable, Hashable, Sendable {
...
public enum BikesAllowed: Int, Codable, Equatable, Hashable, Sendable{
...
public enum TrainType: String, Codable, Hashable, Equatable, Sendable {
    case threeDoor = "2-door"
    case twoDoor = "3-door"
    case unknown = "unknown"
}
public struct StopTime: Identifiable, Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum PickupType: Int, Codable, Equatable, Hashable, Sendable {
...
public enum DropOffType: Int, Codable, Equatable, Hashable, Sendable {
    case regularlyScheduled = 0
...
public enum Timepoint: Int, Codable, Equatable, Hashable, Sendable {
    case approximate = 0
    case exact = 1
...
public struct GTFSCalendar: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let serviceId: String
...
public enum ServiceAvailable: Int, Codable, Equatable, Hashable, Sendable {
...
public struct CalendarDate: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let serviceId: String
...
public enum ExceptionType: Int, Codable, Equatable, Hashable, Sendable {
    case serviceAdded = 1
...
public struct FareAttribute: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum PaymentMethod: Int, Codable, Equatable, Hashable, Sendable {
...
public enum TransfersAllowed: Int, Codable, Equatable, Hashable, Sendable {
    case noTransfers = 0
    case oneTransfer = 1
    case twoTransfers = 2
...
public struct FareRule: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let fareId: String
    public let routeId: String?
...
public struct Shape: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let shapeId: String?
...
public struct Frequency: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let tripId: String
...
public enum ExactTimes: Int, Codable, Equatable, Hashable, Sendable {
...
public struct Transfer: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum TransferType: Int, Codable, Equatable, Hashable, Sendable {
...
public struct Pathway: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum Bidirectional: Int, Codable, Equatable, Hashable, Sendable {
...
public enum PathwayMode: Int, Codable, Equatable, Hashable, Sendable {
    case walkway = 1
    case stairs = 2
...
public struct Level: Codable, FromCSVLine, Equatable, Hashable, Sendable {
    public let levelId: String
...
public struct FeedInfo: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public struct Translation: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum TableName: String, Codable, Equatable, Hashable, Sendable {
    case agency
    case stops
    case routes
    case trips
...
public struct Attribution: Codable, FromCSVLine, Equatable, Hashable, Sendable {
...
public enum HasRole: Int, Codable, Equatable, Hashable, Sendable {
